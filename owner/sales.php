...
<body>
    ...
    <div class="logout-modal" id="logout-modal">
        <div class="logout-modal-content">
            ...
            <button class="confirm-logout">Yes, Log Out</button>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                <a href="#" class="nav-item-logout" id="logout-link">LOG OUT</a>
            </div>
        </aside>
        ...
        <main class="main-content">
            ...
            <section class="sales-filters">
                <div class="top-filters">
                    ...
                    <a href="#" id="compare-btn" class="filter-btn-simple">COMPARE</a>
                </div>
                <div class="bottom-filters">
                    <form action="sales.php" method="GET" class="date-search-form">
                        ...
                        <a href="#" class="download-btn" id="download-pdf-btn">DOWNLOAD PDF</a>
                    </form>
                </div>
            </section>
    ...
    <div id="compare-modal" class="compare-modal">
        <div class="compare-modal-content">
            <span class="close-modal-btn">&times;</span>
            <h2>Compare Sales Data</h2>
            <form action="sales.php" method="GET">
                <input type="hidden" name="filter" value="compare">
                ...
                <button type="submit" class="action-btn" style="width: 100%;">Compare</button>
            </form>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDownloadLink() {
            ...
            // Logic to determine filter_type based on URL params or button clicks
            const urlParams = new URLSearchParams(window.location.search);
            const filter = urlParams.get('filter');

            if (filter === 'this_month') {
                currentFilterType = 'monthly';
                 // Use current month and year, server will know
                downloadBtn.href = `generate_report.php?filter_type=monthly&month=<?php echo date('m'); ?>&year=<?php echo date('Y'); ?>`;
            } else if (filter === 'quarterly') {
                currentFilterType = 'quarterly';
                // Use current month to determine quarter, and selected year
                 downloadBtn.href = `generate_report.php?filter_type=quarterly&month=<?php echo date('m'); ?>&year=<?php echo $year; ?>`;
            } else if (filter === 'annually') {
                currentFilterType = 'annually';
                 downloadBtn.href = `generate_report.php?filter_type=annually&year=<?php echo $year; ?>`;
            } else {
                 // Default to using the dropdowns
                 currentFilterType = 'monthly';
                 downloadBtn.href = `generate_report.php?filter_type=monthly&month=${month}&year=${year}`;
            }
        }
        ...
        const compareCloseBtn = compareModal.querySelector('.close-modal-btn');
